...
export class RewardTierNft1633524567193 implements MigrationInterface {
    name = 'RewardTierNft1633524567193'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // await queryRunner.query(`DROP INDEX "universe-backend"."IDX_user_address"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."reward_tier_nft" ADD "slot" integer NOT NULL`);
