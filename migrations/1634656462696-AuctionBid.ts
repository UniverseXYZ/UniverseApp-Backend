...
export class AuctionBid1634656462696 implements MigrationInterface {
    name = 'AuctionBid1634656462696'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction_bid" ADD "amount" numeric NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction_bid" DROP COLUMN "amount"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction_bid" ADD "amount" integer NOT NULL`);
