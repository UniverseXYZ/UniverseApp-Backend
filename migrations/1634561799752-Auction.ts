...
export class Auction1634561799752 implements MigrationInterface {
    name = 'Auction1634561799752'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // await queryRunner.query(`DROP INDEX "universe-backend"."IDX_user_address"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" ADD "initialised" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" ADD "depositedNfts" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" ADD "canceled" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" ADD "finalised" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" DROP COLUMN "finalised"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" DROP COLUMN "canceled"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" DROP COLUMN "depositedNfts"`);
        await queryRunner.query(`ALTER TABLE "universe-backend"."auction" DROP COLUMN "initialised"`);
