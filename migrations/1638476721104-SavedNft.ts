...
export class SavedNft1638476721104 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "universe-backend"."saved_nft" ADD "metadataStorage" "universe-backend"."saved_nft_metadatastorage_enum" NOT NULL DEFAULT 'offchain'`);
    }
